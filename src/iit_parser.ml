...
include struct
  ...
  let rec _menhir_run_102 : type  ttv_stack. ttv_stack -> _ -> _menhir_box_stmt =
    fun _menhir_stack _v ->
      MenhirBox_stmt _v
  
  let rec _menhir_run_082 : type  ttv_stack. (ttv_stack, _menhir_box_prog) _menhir_cell1_decllist -> _ -> _ -> _menhir_box_prog =
  ...
  let rec _menhir_run_010 : type  ttv_stack. ttv_stack -> _ -> _ -> _ -> (ttv_stack, _menhir_box_prog) _menhir_state -> _ -> _menhir_box_prog =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer _v _menhir_s _tok ->
  ...
  let rec _menhir_run_086 : type  ttv_stack. ttv_stack -> _ -> _ -> _menhir_box_stmt =
    fun _menhir_stack _menhir_lexbuf _menhir_lexer ->
